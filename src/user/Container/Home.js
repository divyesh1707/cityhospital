...
import { H1, H2, H3, H4 } from '../UI/Heading/Heading.style';
import { Icons } from '../UI/Icon/Icon.style';
        ...
        <div>
            ...
            <main id="main">
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-6">
                                <div className="count-box">
                                    <Icons className="fas fa-user-md" />
                                    <span>23</span>
                                    <p>Doctors</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 mt-5 mt-md-0">
                                <div className="count-box">
                                    <Icons className="far fa-hospital" />
                                    <span>18</span>
                                    <p>Departments</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 mt-5 mt-lg-0">
                                <div className="count-box">
                                    <Icons className="fas fa-heartbeat" />
                                    <span>980</span>
                                    <p>Patients</p>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
                                <div className="icon-box">
                                    <div className="icon"><Icons className="fas fa-hospital-alt" /></div>
                            ...
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                                <div className="icon-box">
                                    <div className="icon"><Icons className="fas fa-bed" /></div>
                            ...
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                                <div className="icon-box">
                                    <div className="icon"><Icons className="fas fa-hospital-user" /></div>
                            ...
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                                <div className="icon-box">
                                    <div className="icon"><Icons className="fas fa-dna" /></div>
                            ...
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                                <div className="icon-box">
                                    <div className="icon"><Icons className="fas fa-wheelchair" /></div>
                            ...
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                                <div className="icon-box">
                                    <div className="icon"><Icons className="fas fa-notes-medical" /></div>
                ...
                <section id="testimonials" className="testimonials">
                    <div className="container">
                        <div className="section-title"><H3>Reviews</H3></div>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-wrap">
                                        <div className="testimonial-item">
                                            ...
                                            <h4>Writer</h4>
                                            <p>
                                                <Icons className="bx bxs-quote-alt-left quote-icon-left" />
                                                ...
                                                turpis.
                                                <Icons className="bx bxs-quote-alt-right quote-icon-right" />
                                            </p>
                                        </div>
                                    </div>
                                </div>
